#!/usr/bin/env python
"""
Fix the django_admin_log foreign key constraint to point to auth_user instead of accounts_user
"""
...
def fix_admin_log_constraint():
    ...
    with connection.cursor() as cursor:
        ...
        if constraint:
            ...
            print("   No user_id constraint found!")
            return
        ...
        print("\n3. Cleaning up orphaned admin log entries BEFORE creating new constraint...")
        ...
        if new_constraint:
            print(f"   ✓ New constraint: {new_constraint[0]}")
